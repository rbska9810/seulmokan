...
const metaKeywords=()=>'';
const schemaFor=(title,url,desc,cat)=>({'@context':'https://schema.org','@graph':[{'@type':'WebApplication',name:title,url,description:desc,applicationCategory:'UtilitiesApplication',operatingSystem:'Any',browserRequirements:'JavaScript enabled',isAccessibleForFree:true,offers:{'@type':'Offer',price:'0',priceCurrency:'KRW'},publisher:{'@type':'Organization',name:'쓸모칸',url:base},dateModified:'2026-09-20',inLanguage:'ko-KR'},{'@type':'BreadcrumbList',itemListElement:[{'@type':'ListItem',position:1,name:'홈',item:base},{'@type':'ListItem',position:2,name:cat,item:base+'#tools'},{'@type':'ListItem',position:3,name:title,item:url}]}]});
const notes={
...
applyQuality({root,base,tools,infoPages,notes,guideDetails,esc});
