...
['background-remover','AI 누끼 따기','퍼블리싱·프론트엔드','사진을 외부에 업로드하지 않고 브라우저 AI로 배경을 제거합니다.'],
...
['lunch-worldcup','점심 메뉴 월드컵','미니게임','후보 메뉴를 일대일로 비교해 오늘의 점심 메뉴를 결정합니다.'],
...
'background-remover':['사람이나 사물이 선명하게 나온 JPG, PNG 또는 WebP 이미지 한 장을 선택합니다.','기기에서 AI 모델로 배경을 투명하게 만든 뒤 PNG로 다운로드합니다.','첫 실행에는 AI 모델 다운로드가 필요하고 복잡한 머리카락·반투명 물체는 경계가 부정확할 수 있습니다.'],
...
'lunch-worldcup':['먹고 싶은 점심 메뉴를 한 줄에 하나씩 4~32개 입력합니다.','두 메뉴 중 하나를 계속 선택해 최종 우승 메뉴와 선택 경로를 확인합니다.','홀수 후보는 무작위로 부전승 처리되며 알레르기·식단 조건은 직접 확인하세요.'],
